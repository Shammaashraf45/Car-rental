        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="clientlogin.php"><strong>Renter</strong></a>
                    </li>
                    <li>
                        <a href="customerlogin.php"><strong>Rentee</strong></a>
                    </li>
                    <li>
                        <a href="faq/index.php"><strong>About us</strong></a>
                    </li>
                </ul>
            </div>
                <?php   }
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading" style="color: black">Car-link</h1>
                            <p class="intro-text">
                                Online Car Rental Service for University Students
                            </p>
